...
@section('title', __('farmer.edit_farmer'))
        ...
        <div class="col-md-12 col-lg-12 p-4">       
            ...
            <form action="{{ route('admin.update_user', $user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div id="user-info-section" class="form-section mb-4" 
                    ...
                    <h4>{{ __('farmer.user_info') }}</h4>
                    <div class="row gy-3">

                        {{-- Username field removed --}}
                        <div class="col-md-6">
                            <label class="form-label">{{ __('farmer.full_name') }}</label>
                        ...
                        <div class="col-md-6 user-field">
                            <label class="form-label">{{ __('farmer.password') }}</label>
                            <input type="password" name="password" class="form-control"
                                   placeholder="{{ __('farmer.leave_blank') }}">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">{{ __('farmer.user_type') }}</label>
                        ...
                        <div class="col-md-6 user-field">
                            <label class="form-label">{{ __('farmer.country') }}</label>
                ...
                <button type="submit" class="btn btn-primary px-4">{{ __('farmer.update_user') }}</button>
                <a href="{{ route('admin.list_users') }}" class="btn btn-secondary">{{ __('farmer.back') }}</a>
