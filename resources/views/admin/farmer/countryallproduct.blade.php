...
<div class="row mb-4 gy-3">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="{{ route('products.all.country', ['category' => $item['slug']]) }}"
...
<div class="card shadow-sm mb-4">
        <div class="card-body">
          ...
          <form method="GET" action="{{ route('products.all.country') }}">
              @if($category)
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 mb-3">
                      ...
                      <input type="number" class="form-control" name="min_price" value="{{ request('min_price') }}" placeholder="Min Price">
                  </div>
                  <div class="col-md-3 mb-3">
                  ...
                  <div class="col-md-3 mb-3">
                      ...
                      <input type="number" class="form-control" name="min_yield" value="{{ request('min_yield') }}" placeholder="Min Yield">
                  </div>
                  <div class="col-md-3 mb-3">
                      <label class="form-label">{{ __('labels.max_yield') }}</label>
                      <input type="number" class="form-control" name="max_yield" value="{{ request('max_yield') }}" placeholder="Max Yield">
                  </div>
...
<a href="{{ route('masteradmincountry.view.record',['table'=>$row->table_name,'id'=>$row->id]) }}"
   class="btn btn-sm btn-primary w-max">{{ __('labels.view') }}</a>

<a href="{{ route('countryadmin.upload.record',['table'=>$row->table_name,'id'=>$row->id]) }}"
   class="btn btn-sm btn-success w-max">{{ __('labels.document_upload') }}</a>
