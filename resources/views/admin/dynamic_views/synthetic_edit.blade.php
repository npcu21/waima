        ...
        <div class="col-lg-12 col-md-12 p-4">
            <div class="form-section">
                ...
                @php
                    // Fields to hide
                    $hiddenFields = [
                        'created_by', 'agent_id', 'supplier_id', 'qr_code_path', 
                        'id', 'created_at', 'updated_at','product_id','language_id',
                        'reject_reason','title','form_type'
                    ];
                @endphp
                        ...
                        @foreach($record as $field => $value)
                            ...
                            @if(!in_array($field, $hiddenFields))
                                ...
                                <div class="col-md-6 mb-3">
                                    <label>{{ __('labels.' . $field, [], app()->getLocale()) }}</label>
